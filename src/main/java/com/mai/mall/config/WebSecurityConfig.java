package com.mai.mall.config;

import com.mai.mall.security.AuthenticationEntryPointImpl;
import com.mai.mall.security.LogoutSuccessHandlerImpl;
import com.mai.mall.common.filter.TokenFilter;
...
//                .antMatchers("/swagger-ui/**", "/swagger-resources/**", "/webjars/**", "/*/api-docs", "/druid/**").permitAll()
    ...
    public void configure(WebSecurity web) {
        web.ignoring().antMatchers("/health", "/user/login", "/register")
